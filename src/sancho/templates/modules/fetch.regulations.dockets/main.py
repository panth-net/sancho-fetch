...
def run(*, context: ModuleContext, payload: dict[str, Any]) -> dict[str, Any]:
    api = _load_sibling("api.py", "sancho_fetch_regulations_dockets_api")
    transform = _load_sibling("transform.py", "sancho_fetch_regulations_dockets_transform")

    endpoint = str(payload.get("endpoint", "https://api.regulations.gov/v4/dockets"))
