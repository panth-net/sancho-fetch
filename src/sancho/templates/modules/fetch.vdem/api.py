...
def fetch_vdem_core(
    *,
    ...
    # Keep the original archive in the cache record byte-for-byte.
    from sancho.runtime.net import note_original_bytes
    note_original_bytes(path=archive_path, filename_or_url=url)
