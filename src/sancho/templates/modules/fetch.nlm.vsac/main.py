...
CONFIG = {'module_id': 'fetch.nlm.vsac', 'dataset_ref': 'usgov_nlm_vsac', 'default_endpoint': 'https://vsac.nlm.nih.gov/', 'default_params': {}, 'default_mode': 'html_links', 'default_search': 'API', 'default_limit': 25, 'preferred_keys': ['data', 'results', 'items', 'features', 'dataset']}
