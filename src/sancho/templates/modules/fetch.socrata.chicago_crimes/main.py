...
def run(*, context: ModuleContext, payload: dict[str, Any]) -> dict[str, Any]:
    api = _load_sibling("api.py", "sancho_fetch_socrata_chicago_crimes_api")
    transform = _load_sibling("transform.py", "sancho_fetch_socrata_chicago_crimes_transform")

    endpoint = str(payload.get("endpoint", "https://data.cityofchicago.org/resource/ijzp-q8t2.json"))
