...
def run(*, context: ModuleContext, payload: dict[str, Any]) -> dict[str, Any]:
    api = _load_sibling("api.py", "sancho_fetch_fsi_api")
    transform = _load_sibling("transform.py", "sancho_fetch_fsi_transform")
    ...
    family_or_dataset_id = f"fsi_{year or 'latest'}"
