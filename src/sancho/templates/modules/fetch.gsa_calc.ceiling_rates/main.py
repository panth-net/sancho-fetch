...
def run(*, context: ModuleContext, payload: dict[str, Any]) -> dict[str, Any]:
    api = _load_sibling("api.py", "sancho_fetch_gsa_calc_ceiling_rates_api")
    transform = _load_sibling("transform.py", "sancho_fetch_gsa_calc_ceiling_rates_transform")

    endpoint = str(payload.get("endpoint", "https://api.gsa.gov/acquisition/calc/v3/api/ceilingrates/"))
