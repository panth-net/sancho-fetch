...
def run(*, context: ModuleContext, payload: dict[str, Any]) -> dict[str, Any]:
    api = _load_sibling("api.py", "sancho_fetch_ti_cpi_api")
    transform = _load_sibling("transform.py", "sancho_fetch_ti_cpi_transform")
    ...
    family_or_dataset_id = f"ti_cpi_{year or 'latest'}"
