...
CONFIG = {
    "module_id": "fetch.epa.ejscreen",
    "dataset_ref": "usgov_epa_ejscreen",
    "default_endpoint": "https://www.epa.gov/newsreleases/epa-launches-updates-environmental-justice-mapping-tool-ejscreen",
    "default_params": {},
