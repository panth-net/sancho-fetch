...
MODULE_ID = "fetch.rsf_press_freedom"
...
def run(*, context: ModuleContext, payload: dict[str, Any]) -> dict[str, Any]:
    api = _load_sibling("api.py", "sancho_fetch_rsf_api")
    transform = _load_sibling("transform.py", "sancho_fetch_rsf_transform")
    ...
    family_or_dataset_id = f"rsf_{year or 'latest'}"
