...
def run(*, context: ModuleContext, payload: dict[str, Any]) -> dict[str, Any]:
    api = _load_sibling("api.py", "sancho_fetch_naep_adhoc_data_api")
    transform = _load_sibling("transform.py", "sancho_fetch_naep_adhoc_data_transform")

    endpoint = str(payload.get("endpoint", "https://www.nationsreportcard.gov/Dataservice/GetAdhocData.aspx"))
