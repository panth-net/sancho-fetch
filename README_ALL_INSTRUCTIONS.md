...
Sancho Fetch code is licensed under the Mozilla Public License 2.0.

Documentation and guides are licensed under CC BY 4.0 unless otherwise noted.

The Sancho name, Sancho Fetch name, logo, and brand assets are protected separately. The Mozilla Public License 2.0 does not grant trademark or brand rights.
