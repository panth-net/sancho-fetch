...
Use this workflow to add modules manually.
...
For fetch modules, also create the files required by the selected pattern and tier.
...
Every `module.yaml` should include:
...
Create the smallest useful test first, then cover the relevant checks in the workflow above.
...
4. Keep module code minimal and readable.
5. Run focused tests after creating or changing a module.
